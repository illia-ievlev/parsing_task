package com.ievlev.parsing_task.mapper;

import com.ievlev.parsing_task.extractors.HtmlDataExtractor;
import com.ievlev.parsing_task.dto.all_jobs_dto.JobFunctions;
import com.ievlev.parsing_task.dto.all_jobs_dto.JobHit;
import com.ievlev.parsing_task.dto.all_jobs_dto.Organization;
...
public class JobHitToJobMapper {
    private final HtmlDataExtractor htmlDataExtractor;
    private static final String NOT_FOUND = "NOT_FOUND";

    public Job createJobFromHit(JobHit jobHit) {
        Job job = new Job();
        job.setPositionName(jobHit.getTitle());
        job.setOrganizationUrl(htmlDataExtractor.getUrlToOrganization(jobHit.getSlug()));
        ...
        job.setDescription(htmlDataExtractor.getDescription(jobHit.getSlug(), jobHit.isHas_description()));
